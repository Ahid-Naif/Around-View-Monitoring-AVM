...
ap.add_argument("-f", "--firstImage", required=True, help="right image")
ap.add_argument("-s", "--secondImage", required=True, help="left image")
args = vars(ap.parse_args())

img1 = cv2.imread(args["firstImage"]) # queryImage -- right image
img2 = cv2.imread(args["secondImage"]) # trainImage -- left image
